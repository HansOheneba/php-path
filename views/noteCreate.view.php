...
<form method="post">
   <div class="w-full rounded-lg bg-gray-200 ">
       ...
       <label for="body" class="block mb-2 font-semibold text-gray-900 text-lg">Your note</label>
           <textarea id="body" name="body" rows="4" class="w-full p-2  text-sm text-gray-900 bg-white border-0  focus:ring-0" placeholder="Write down your thoughts..." required ></textarea>
       </div>
